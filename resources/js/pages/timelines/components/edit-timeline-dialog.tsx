...
export function EditTimelineDialog({
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        router.put(`/timelines/${timeline.id}`, submitData, {
            preserveScroll: true,
            onSuccess: () => {
                onOpenChange(false);
        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            ...
            >
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Update timeline details and schedule
                    </DialogDescription>
                </DialogHeader>
                <form onSubmit={handleSubmit} className="flex flex-col">
                                ...
                                <div className="grid gap-2">
                                    ...
                                    <p className="text-xs text-muted-foreground">
                                        {existingSprints.length > 0
                                            ? `Existing sprints: ${existingSprints.join(', ')}`
                                            : 'Multiple timelines can share the same sprint'}
                                    </p>
                                    {errors.sprint_number && (
                                        <p className="text-sm text-destructive">
                                            {errors.sprint_number}
                    ...
                    <div className="flex justify-end gap-2 border-t pt-4">
                        ...
                        <Button type="submit" disabled={isSubmitting}>
                            {isSubmitting ? 'Updating...' : 'Update Timeline'}
                        </Button>
                    </div>
                </form>
            </DialogContent>
